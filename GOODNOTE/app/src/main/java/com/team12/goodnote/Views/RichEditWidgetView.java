package com.team12.goodnote.Views;
...
public class RichEditWidgetView extends HorizontalScrollView{
	...
	int[] effectIcons = new int[] {
			R.drawable.ic_format_bold_24dp,
			R.drawable.ic_format_italic_24dp,
			R.drawable.ic_format_underlined_24dp,
			R.drawable.ic_format_strikethrough_24dp,
			R.drawable.ic_format_subscript_24dp,
			R.drawable.ic_format_superscript_24dp,
	};
